...
```
┌──────────────────────────────────────────────────────────────────────────┐
│ Phase │ Action              │ Type     │ Default dt │ Optimized dt │ Typ  │
├───────┼─────────────────────┼──────────┼────────────┼──────────────┼──────┤
│  0    │ Move above cube     │ Position │ 0.008 s    │ 1.0 s        │ AIR  │
│  1    │ Lower to grip       │ Position │ 0.005 s    │ 0.015 s      │ CRIT │
│  2    │ Wait for settle     │ Time     │ 0.1 s      │ 1.0 s        │ WAIT │
│  3    │ Close gripper       │ Gripper  │ 0.1 s      │ 0.2 s        │ GRIP │
│  4    │ Lift with cube      │ Position │ 0.05 s     │ 1.0 s        │ AIR  │
│  5    │ Move to target XY   │ Position │ 0.05 s     │ 1.0 s        │ AIR  │
│  6    │ Lower to place      │ Position │ 0.0025 s   │ 0.015 s      │ CRIT │
│  7    │ Open gripper        │ Gripper  │ 1 s        │ 0.2 s        │ REL  │
│  8    │ Lift up             │ Position │ 0.008 s    │ 1.0 s        │ AIR  │
│  9    │ Return to start     │ Position │ 0.08 s     │ 1.0 s        │ AIR  │
└───────┴─────────────────────┴──────────┴────────────┴──────────────┴──────┘

AIR Phasen:      0, 4, 5, 8, 9  (können schnell sein → dt=1.0s)
CRITICAL Phasen: 1, 6           (müssen präzise sein → dt=0.015s)

🎉 DURCHBRUCH (2026-01-25): Mit optimierten dt-Werten: ~150 Steps/Episode (1 Würfel)
   statt ~950 Steps (2 Würfel) → Erstes erfolgreiches Training!
```
