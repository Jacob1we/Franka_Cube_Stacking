...
class Base_StackingController(BaseController):
    """[summary]
    ...
    def __init__(
        ...
        # self._pick_place_controller = pp
        ...
        self.log = logging.getLogger("BaseStackingController")
        self.log.info("Initiation of Base Stacking Controller is Done")
        self.reset()
    ...
    def forward(
        ...
        actions = self._pick_place_controller.forward(
            ...
            picking_orientation=observations[self._picking_order_cube_names[self._current_cube]]["orientation"], #JW
